...
async function connectToWA() {
  ...
  conn.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      let up = `CHALAH_MD connected successful ✅\n\nPREFIX: ${prefix}`;
      conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: 'https://i.ibb.co/vvMr8jcV/7873.jpg' }, caption: up });
    }
  });
  ...
  conn.ev.on('messages.upsert', async(mek) => {
    ...
    const statesender = ["ewapanko", "dapan", "dapn", "ewhahn", "ewanna", "danna", "evano", "evpn", "ewano"];
